...
794 tokens across five axes, `brand.md` approved at Gate A, 8 L1 primitives. RED holds
...
| 2 | `token-keeper` → `tokens/tokens.json` v0 | **done** — 794 tokens, 5 axes, 0 literals above the primitive layer |
