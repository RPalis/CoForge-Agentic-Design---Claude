# Checklist — competitive-benchmark

**Stage:** discover · **Owner:** `research-synthesizer`

> Comparison against competitors on named dimensions.

## Gate B — automatic (blocks)

- [ ] Artifact is a directory named `YYYY-MM-DD__competitive-benchmark__<slug>__v<N>`
