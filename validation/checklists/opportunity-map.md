# Checklist — opportunity-map

**Stage:** define · **Owner:** `research-synthesizer`

> Opportunity solution tree or equivalent.

## Gate B — automatic (blocks)

- [ ] Artifact is a directory named `YYYY-MM-DD__opportunity-map__<slug>__v<N>`
