# Checklist — release-note

**Stage:** deliver · **Owner:** `content-comms`

> What shipped, for whom, and what changed.

## Gate B — automatic (blocks)

- [ ] Artifact is a directory named `YYYY-MM-DD__release-note__<slug>__v<N>`
