...
**Stage:** develop · **Owner:** `diagram-cartographer`

> Task flow with decision points and error paths.

## Gate B — automatic (blocks)

- [ ] Artifact is a directory named `YYYY-MM-DD__user-flow__<slug>__v<N>`
